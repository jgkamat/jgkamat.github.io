...
* Overview
:PROPERTIES:
:CUSTOM_ID: h:ua1fi9s0gyh0
:END:

*NOTE:* My website used to be build with ox-twbs, now it's built on ox-html.
Commit [[https://github.com/jgkamat/jgkamat.github.io/tree/bb5eadb640f982a0acdc6713dd99bfce64328798][bb5eadb6]] is one of the last to use ox-twbs.
...
* Org Projects
:PROPERTIES:
:CUSTOM_ID: h:vw6fi9s0gyh0
:END:
** Basic Setup
:PROPERTIES:
:CUSTOM_ID: h:n3bfi9s0gyh0
:END:
