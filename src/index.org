...
6. [[https://github.com/jgkamat/JayLayer/][JayLayer]]              

  MP3 wrapper library to make sound easy!
7. [[https://github.com/jgkamat/JPlanetSimulator][JPlanetSimulator]]      

  A 2D Planet Simulation using Newton's Laws
